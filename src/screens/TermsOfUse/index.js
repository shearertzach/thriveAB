    ...
    return (
      <div className={style['c-terms']}>
        ...
        <ul>
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ThriveAB.</li>
          <li><strong>Country</strong> refers to: Kentucky, United States</li>
          ...
          <li><strong>Website</strong> refers to ThriveAB, accessible from www.thriveab.app</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
        </ul>
        ...
        <ul>
          <li>By mail: 475 Trojan Trail Glasgow, KY 42141, United States</li>
        </ul>
      </div>
    )
  }
